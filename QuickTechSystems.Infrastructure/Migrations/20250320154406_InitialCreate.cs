    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrawerHistory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlySalary = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashierId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CashierName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CashierRole = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrawerTransactions", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK_DrawerTransactions_Drawers_DrawerId",
                        column: x => x.DrawerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DamagedGoodsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DamagedGoods", x => x.DamagedGoodsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "LowStockHistories",
                columns: table => new
                {
                    LowStockHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ProductName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CurrentStock = table.Column<int>(type: "int", nullable: false),
                    ...
                    CashierId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LowStockHistories", x => x.LowStockHistoryId);
                    table.ForeignKey(
                        name: "FK_LowStockHistories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrawerTransactions_ActionType",
                table: "DrawerTransactions",
                column: "ActionType");

            migrationBuilder.CreateIndex(
                name: "IX_DrawerTransactions_DrawerId",
                table: "DrawerTransactions",
                column: "DrawerId");

            migrationBuilder.CreateIndex(
                name: "IX_DrawerTransactions_IsVoided",
                table: "DrawerTransactions",
                column: "IsVoided");

            migrationBuilder.CreateIndex(
                name: "IX_DrawerTransactions_Timestamp",
                table: "DrawerTransactions",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_DrawerTransactions_TransactionReference",
                table: "DrawerTransactions",
                column: "TransactionReference");

            migrationBuilder.CreateIndex(
                name: "IX_DrawerTransactions_Type",
                table: "DrawerTransactions",
                column: "Type");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSalaryTransactions_TransactionDate",
                table: "EmployeeSalaryTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LowStockHistories_AlertDate",
                table: "LowStockHistories",
                column: "AlertDate");

            migrationBuilder.CreateIndex(
                name: "IX_LowStockHistories_ProductId",
                table: "LowStockHistories",
                column: "ProductId");
