...
namespace QuickTechSystems.WPF.ViewModels
{
    public class ExpenseViewModel : ViewModelBase
    {
        ...
        private void ApplyFilter()
        {
            ...
            {
                Debug.WriteLine($"Summary: {summary.CategoryName}, Count: {summary.Count}, Total: {summary.TotalAmount:N}");
            }
            ...
            Debug.WriteLine($"Final summary totals - Count: {summaries.Last().Count}, Amount: {summaries.Last().TotalAmount:N}");
        ...
        private async Task SaveAsync()
        {
            ...
            try
            {
                ...
                Debug.WriteLine($"Created expense clone for saving: ID: {expenseToSave.ExpenseId}, Reason: {expenseToSave.Reason}, Amount: {expenseToSave.Amount:N}");
                ...
                Debug.WriteLine($"Drawer found with balance: {drawer.CurrentBalance:N}");

                if (expenseToSave.Amount > drawer.CurrentBalance)
                {
                    Debug.WriteLine($"Insufficient funds: Expense amount ({expenseToSave.Amount:N}) > Drawer balance ({drawer.CurrentBalance:N})");
