// Path: QuickTechSystems.WPF.Views/ProductSearchPopupForDamaged.xaml.cs
...
{
    public partial class ProductSearchPopupForDamaged : UserControl
    {
        public ProductSearchPopupForDamaged()
        {
            InitializeComponent();
        }
