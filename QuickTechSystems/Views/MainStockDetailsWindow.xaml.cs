// Path: QuickTechSystems.WPF.Views/MainStockDetailsWindow.xaml.cs
using System;
...
{
    public partial class MainStockDetailsWindow : Window
    {
                ...
                if (result == true && dialog.NewCategory != null)
                {
                    ...
                    try
                    {
                        ...
                        if (DataContext is MainStockViewModel viewModel)
                        {
                            ...
                            {
                                viewModel.SelectedItem.CategoryId = newCategory.CategoryId;
                                viewModel.SelectedItem.CategoryName = newCategory.Name;
                            }
                ...
                if (result == true && dialog.NewSupplier != null)
                {
                    ...
                    try
                    {
                        ...
                        if (DataContext is MainStockViewModel viewModel)
                        {
                            ...
                            if (viewModel.SelectedItem != null)
                            {
                                viewModel.SelectedItem.SupplierId = newSupplier.SupplierId;
                                viewModel.SelectedItem.SupplierName = newSupplier.Name;
                            }
