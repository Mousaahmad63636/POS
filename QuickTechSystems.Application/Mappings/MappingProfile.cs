    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            CreateMap<Product, ProductDTO>()
                ...
                .ForMember(dest => dest.PlantsHardscapeName, opt => opt.MapFrom(src => src.PlantsHardscape != null ? src.PlantsHardscape.Name : string.Empty))
                .ForMember(dest => dest.LocalImportedName, opt => opt.MapFrom(src => src.LocalImported != null ? src.LocalImported.Name : string.Empty))
                .ForMember(dest => dest.IndoorOutdoorName, opt => opt.MapFrom(src => src.IndoorOutdoor != null ? src.IndoorOutdoor.Name : string.Empty))
                .ForMember(dest => dest.PlantFamilyName, opt => opt.MapFrom(src => src.PlantFamily != null ? src.PlantFamily.Name : string.Empty))
                .ForMember(dest => dest.DetailName, opt => opt.MapFrom(src => src.Detail != null ? src.Detail.Name : string.Empty));
